...
logging.basicConfig(
    level=logging.INFO,
    filename="/Users/edony/code/MCP/servers/mcp-obsidian/mcp-obsidian.log",
)
...
async def call_tool(
    ...
    try:
        logger.info(f"Calling tool: {name} with arguments: {json.dumps(arguments)}")
...
async def main():
    ...
    logger.info("{} starting...".format(time.strftime("%Y-%m-%d %H:%M:%S")))
    print("starting...")
